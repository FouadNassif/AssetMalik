<div class="bottom-20 relative flex flex-col justify-center items-center w-fullq h-screen text-center text-S ">
    ...
    <div class="relative z-50 leading-loose">
        <p class="font-Lit text-5xl">FINEST QUALITY</p>
        <h1 class="text-7xl scale-y-150 mb-5 mt-3 font-black">A S S E T M A L I K</h1>
        <p class=" mb-3 font-Lit text-5xl">B A R B E R S H O P</p>
